...
080004a0 <main>:
 ...
 80004f2:	f025 f98d 	bl	8025810 <HAL_Init>
...
08000690 <Serial_Printf>:
 ...
 80006a6:	f024 fd5f 	bl	8025168 <tiny_vsnprintf_like>
...
080006d4 <FLASH_If_Erase>:
 ...
 80006de:	f028 fa8b 	bl	8028bf8 <HAL_FLASH_Unlock>
 ...
 8000706:	f028 fc8b 	bl	8029020 <HAL_FLASHEx_Erase>
 800070a:	b928      	cbnz	r0, 8000718 <FLASH_If_Erase+0x44>
 800070c:	2400      	movs	r4, #0
 800070e:	f028 fa85 	bl	8028c1c <HAL_FLASH_Lock>
...
08000720 <FLASH_If_Write>:
 ...
 800072a:	f028 fa65 	bl	8028bf8 <HAL_FLASH_Unlock>
 ...
 800074c:	f028 fad2 	bl	8028cf4 <HAL_FLASH_Program>
 ...
 800076a:	f028 fa57 	bl	8028c1c <HAL_FLASH_Lock>
...
08000774 <PreJump>:
 ...
 800077c:	f024 fffc 	bl	8025778 <HAL_DeInit>
...
080007ac <HAL_FLASH_Program_Flag>:
 ...
 80007c2:	f028 fa19 	bl	8028bf8 <HAL_FLASH_Unlock>
 ...
 80007e2:	f028 fc1d 	bl	8029020 <HAL_FLASHEx_Erase>
 ...
 80007f6:	f028 fa7d 	bl	8028cf4 <HAL_FLASH_Program>
 80007fa:	f028 fa0f 	bl	8028c1c <HAL_FLASH_Lock>
...
0800093a <SysTick_Handler>:
 ...
 800093c:	f024 ff7e 	bl	802583c <HAL_IncTick>
 8000940:	f024 ff88 	bl	8025854 <HAL_GetTick>
...
0800094c <RTC_Alarm_IRQHandler>:
 ...
 8000950:	f026 fb6a 	bl	8027028 <HAL_RTC_AlarmIRQHandler>
...
0800095c <SUBGHZ_Radio_IRQHandler>:
 ...
 8000960:	f028 fe47 	bl	80295f2 <HAL_SUBGHZ_IRQHandler>
...
0800096c <TAMP_STAMP_LSECSS_SSRU_IRQHandler>:
 ...
 8000970:	f027 fb94 	bl	802809c <HAL_RTCEx_SSRUIRQHandler>
...
0800098c <MX_USART2_UART_Init>:
 ...
 80009d4:	f020 fe4c 	bl	8021670 <Error_Handler>
 80009d8:	e7ed      	b.n	80009b6 <MX_USART2_UART_Init+0x2a>
 80009da:	f020 fe49 	bl	8021670 <Error_Handler>
 80009de:	e7ef      	b.n	80009c0 <MX_USART2_UART_Init+0x34>
 80009e0:	f020 fe46 	bl	8021670 <Error_Handler>
 80009e4:	e7f1      	b.n	80009ca <MX_USART2_UART_Init+0x3e>
 80009e6:	f020 fe43 	bl	8021670 <Error_Handler>
...
08000a24 <HAL_UART_MspInit>:
 ...
 8000a56:	f025 fe91 	bl	802677c <HAL_RCCEx_PeriphCLKConfig>
 ...
 8000a9e:	f028 fe5b 	bl	8029758 <HAL_GPIO_Init>
 8000aa2:	4622      	mov	r2, r4
 8000aa4:	4621      	mov	r1, r4
 8000aa6:	2025      	movs	r0, #37	; 0x25
 8000aa8:	f022 f9b8 	bl	8022e1c <HAL_NVIC_SetPriority>
 8000aac:	2025      	movs	r0, #37	; 0x25
 8000aae:	f022 f9e7 	bl	8022e80 <HAL_NVIC_EnableIRQ>
 8000ab2:	e7c8      	b.n	8000a46 <HAL_UART_MspInit+0x22>
 8000ab4:	f020 fddc 	bl	8021670 <Error_Handler>
...
08000ac0 <HAL_UART_MspDeInit>:
 ...
 8000ade:	f028 feed 	bl	80298bc <HAL_GPIO_DeInit>
 8000ae2:	2025      	movs	r0, #37	; 0x25
 8000ae4:	f022 f9da 	bl	8022e9c <HAL_NVIC_DisableIRQ>
...
08000fa8 <fuota_FragDecoderRead>:
 ...
 8000fb8:	f020 fa10 	bl	80213dc <udrv_flash_read>
...
08000fc0 <fuota_FragDecoderWrite>:
 ...
 8000fd0:	f020 faae 	bl	8021530 <udrv_flash_write>
...
08000fd8 <MlmeConfirm_fuota>:
 ...
 8000fde:	f023 ff55 	bl	8024e8c <UTIL_TIMER_IsRunning>
 ...
 8000ff8:	f023 ffb8 	bl	8024f6c <UTIL_TIMER_Stop>
 8000ffc:	f644 6120 	movw	r1, #20000	; 0x4e20
 8001000:	4628      	mov	r0, r5
 8001002:	f024 f855 	bl	80250b0 <UTIL_TIMER_SetPeriod>
 8001006:	4628      	mov	r0, r5
 8001008:	f024 f800 	bl	802500c <UTIL_TIMER_Start>
...
08001040 <McpsIndication_fuota>:
 ...
 8001046:	f023 ff21 	bl	8024e8c <UTIL_TIMER_IsRunning>
 ...
 8001066:	f023 ff81 	bl	8024f6c <UTIL_TIMER_Stop>
 800106a:	f644 6120 	movw	r1, #20000	; 0x4e20
 800106e:	4628      	mov	r0, r5
 8001070:	f024 f81e 	bl	80250b0 <UTIL_TIMER_SetPeriod>
 8001074:	4628      	mov	r0, r5
 8001076:	f023 ffc9 	bl	802500c <UTIL_TIMER_Start>
...
08001084 <bootloader_fuota_stack_init>:
 ...
 800108e:	f03a fa3b 	bl	803b508 <memcpy>
 ...
 80010a8:	0803c010 	.word	0x0803c010
...
0800111c <fuota_LmHandlerRegister>:
 ...
 8001132:	f01f fc3f 	bl	80209b4 <LmhpRemoteMcastSetupPackageFactory>
 ...
 8001146:	f01f fe59 	bl	8020dfc <LmhpFragmentationPackageFactory>
...
08001160 <bootloader_fuota_init>:
 ...
 8001166:	f02f fd0d 	bl	8030b84 <LoRaMacUpdateCallbacks>
 ...
 8001172:	f020 ff75 	bl	8022060 <service_nvm_get_adr_from_nvm>
 8001176:	3800      	subs	r0, #0
 8001178:	bf18      	it	ne
 800117a:	2001      	movne	r0, #1
 800117c:	7060      	strb	r0, [r4, #1]
 800117e:	f020 ff39 	bl	8021ff4 <service_nvm_get_cfm_from_nvm>
 8001182:	70a0      	strb	r0, [r4, #2]
 8001184:	f020 ff90 	bl	80220a8 <service_nvm_get_dr_from_nvm>
 8001188:	70e0      	strb	r0, [r4, #3]
 800118a:	2501      	movs	r5, #1
 800118c:	7125      	strb	r5, [r4, #4]
 800118e:	f021 fabf 	bl	8022710 <service_nvm_get_dcs_from_nvm>
 ...
 80011b0:	f01f ff16 	bl	8020fe0 <FragDecoderUpdateCallback>
...
080011d8 <fuota_init>:
 ...
 80011e2:	f020 fdad 	bl	8021d40 <service_nvm_get_band_from_nvm>
 ...
 8001202:	f02d fbfb 	bl	802e9fc <LoRaMacInitialization>
 ...
 8001210:	f020 ff26 	bl	8022060 <service_nvm_get_adr_from_nvm>
 8001214:	3800      	subs	r0, #0
 8001216:	bf18      	it	ne
 8001218:	2001      	movne	r0, #1
 800121a:	7060      	strb	r0, [r4, #1]
 800121c:	f020 feea 	bl	8021ff4 <service_nvm_get_cfm_from_nvm>
 8001220:	70a0      	strb	r0, [r4, #2]
 8001222:	f020 ff41 	bl	80220a8 <service_nvm_get_dr_from_nvm>
 8001226:	70e0      	strb	r0, [r4, #3]
 8001228:	2301      	movs	r3, #1
 800122a:	7123      	strb	r3, [r4, #4]
 800122c:	f021 fa70 	bl	8022710 <service_nvm_get_dcs_from_nvm>
 ...
 8001250:	f02d fdb0 	bl	802edb4 <LoRaMacStart>
 8001254:	2000      	movs	r0, #0
 8001256:	bd10      	pop	{r4, pc}
 8001258:	2001      	movs	r0, #1
 800125a:	f031 ffa1 	bl	80331a0 <RegionAS923SubBandSet>
 800125e:	e7c5      	b.n	80011ec <fuota_init+0x14>
 8001260:	2002      	movs	r0, #2
 8001262:	f031 ff9d 	bl	80331a0 <RegionAS923SubBandSet>
 8001266:	e7c3      	b.n	80011f0 <fuota_init+0x18>
 8001268:	2003      	movs	r0, #3
 800126a:	f031 ff99 	bl	80331a0 <RegionAS923SubBandSet>
 800126e:	e7c1      	b.n	80011f4 <fuota_init+0x1c>
 8001270:	2004      	movs	r0, #4
 8001272:	f031 ff95 	bl	80331a0 <RegionAS923SubBandSet>
...
0800129c <bootloader_fuota_start>:
 ...
 80012ce:	f021 fda5 	bl	8022e1c <HAL_NVIC_SetPriority>
 80012d2:	200b      	movs	r0, #11
 80012d4:	f021 fdd4 	bl	8022e80 <HAL_NVIC_EnableIRQ>
 80012d8:	f023 fda8 	bl	8024e2c <UTIL_TIMER_Init>
 ...
 80012f4:	f023 fdaa 	bl	8024e4c <UTIL_TIMER_Create>
 80012f8:	f644 6120 	movw	r1, #20000	; 0x4e20
 80012fc:	4620      	mov	r0, r4
 80012fe:	f023 fed7 	bl	80250b0 <UTIL_TIMER_SetPeriod>
 8001302:	4620      	mov	r0, r4
 8001304:	f023 fe82 	bl	802500c <UTIL_TIMER_Start>
...
08001394 <UplinkProcess>:
 ...
 80013d0:	f02b fb16 	bl	802ca00 <randr>
...
08001420 <timer_callback>:
 ...
 8001422:	f02c ff03 	bl	802e22c <LoRaMacIsBusy>
...
08001538 <HAL_UART_AbortReceive_IT>:
 ...
 800159c:	f02b f8a0 	bl	802c6e0 <HAL_DMA_Abort_IT>
...
08001634 <HAL_UART_IRQHandler>:
 ...
 80017c6:	f02a ff8b 	bl	802c6e0 <HAL_DMA_Abort_IT>
 ...
 800189a:	f02a feeb 	bl	802c674 <HAL_DMA_Abort>
...
08001e0c <UART_SetConfig>:
 ...
 8001f6a:	f024 faaf 	bl	80264cc <HAL_RCC_GetPCLK1Freq>
 ...
 8001fc8:	f023 fe70 	bl	8025cac <HAL_RCC_GetSysClockFreq>
 ...
 8001fe8:	f024 fa70 	bl	80264cc <HAL_RCC_GetPCLK1Freq>
 ...
 8002028:	f024 fa60 	bl	80264ec <HAL_RCC_GetPCLK2Freq>
 800202c:	e7de      	b.n	8001fec <UART_SetConfig+0x1e0>
 800202e:	f023 fe3d 	bl	8025cac <HAL_RCC_GetSysClockFreq>
 ...
 8002038:	f024 fa48 	bl	80264cc <HAL_RCC_GetPCLK1Freq>
 ...
 800207c:	f024 fa36 	bl	80264ec <HAL_RCC_GetPCLK2Freq>
 8002080:	e7dc      	b.n	800203c <UART_SetConfig+0x230>
 8002082:	f023 fe13 	bl	8025cac <HAL_RCC_GetSysClockFreq>
...
080021a2 <UART_WaitOnFlagUntilTimeout>:
 ...
 80021ce:	f023 fb41 	bl	8025854 <HAL_GetTick>
...
0800227e <HAL_UART_Transmit>:
 ...
 80022b6:	f023 facd 	bl	8025854 <HAL_GetTick>
...
0800235c <HAL_UART_Receive>:
 ...
 8002398:	f023 fa5c 	bl	8025854 <HAL_GetTick>
...
08002488 <UART_CheckIdleState>:
 ...
 8002494:	f023 f9de 	bl	8025854 <HAL_GetTick>
...
080027fc <Reset_Handler>:
 ...
 8002800:	f01e ff48 	bl	8021694 <SystemInit>

...
080001d0 <at_process>:
 ...
 8000250:	f03a f94c 	bl	803a4ec <memcmp>
 ...
 800025e:	f03a f945 	bl	803a4ec <memcmp>
 ...
 800026c:	f02e fd64 	bl	802ed38 <LoRaMacProcess>
 ...
 80002fc:	f01e fb04 	bl	801e908 <service_lora_fuota_join>
...
08000404 <SystemClock_Config>:
 ...
 8000420:	f026 ffee 	bl	8027400 <HAL_PWR_EnableBkUpAccess>
 ...
 8000472:	f024 fc77 	bl	8024d64 <HAL_RCC_OscConfig>
 ...
 800048c:	f024 ff0c 	bl	80252a8 <HAL_RCC_ClockConfig>
 8000490:	b918      	cbnz	r0, 800049a <SystemClock_Config+0x96>
 8000492:	b01a      	add	sp, #104	; 0x68
 8000494:	bd10      	pop	{r4, pc}
 8000496:	f020 f8d1 	bl	802063c <Error_Handler>
 800049a:	f020 f8cf 	bl	802063c <Error_Handler>
	...
...
080004a0 <main>:
 ...
 80004f2:	f024 f96b 	bl	80247cc <HAL_Init>
...
08000690 <Serial_Printf>:
 ...
 80006a6:	f023 fd3d 	bl	8024124 <tiny_vsnprintf_like>
 80006aa:	a802      	add	r0, sp, #8
 80006ac:	f01c fca8 	bl	801d000 <strlen>
...
080006d4 <FLASH_If_Erase>:
 ...
 80006de:	f027 fa69 	bl	8027bb4 <HAL_FLASH_Unlock>
 ...
 8000706:	f027 fc69 	bl	8027fdc <HAL_FLASHEx_Erase>
 800070a:	b928      	cbnz	r0, 8000718 <FLASH_If_Erase+0x44>
 800070c:	2400      	movs	r4, #0
 800070e:	f027 fa63 	bl	8027bd8 <HAL_FLASH_Lock>
...
08000720 <FLASH_If_Write>:
 ...
 800072a:	f027 fa43 	bl	8027bb4 <HAL_FLASH_Unlock>
 ...
 800074c:	f027 fab0 	bl	8027cb0 <HAL_FLASH_Program>
 ...
 800076a:	f027 fa35 	bl	8027bd8 <HAL_FLASH_Lock>
...
08000774 <PreJump>:
 ...
 800077c:	f023 ffda 	bl	8024734 <HAL_DeInit>
...
080007ac <HAL_FLASH_Program_Flag>:
 ...
 80007c2:	f027 f9f7 	bl	8027bb4 <HAL_FLASH_Unlock>
 ...
 80007e2:	f027 fbfb 	bl	8027fdc <HAL_FLASHEx_Erase>
 ...
 80007f6:	f027 fa5b 	bl	8027cb0 <HAL_FLASH_Program>
 80007fa:	f027 f9ed 	bl	8027bd8 <HAL_FLASH_Lock>
...
0800093a <SysTick_Handler>:
 ...
 800093c:	f023 ff5c 	bl	80247f8 <HAL_IncTick>
 8000940:	f023 ff66 	bl	8024810 <HAL_GetTick>
...
0800094c <RTC_Alarm_IRQHandler>:
 ...
 8000950:	f025 fb48 	bl	8025fe4 <HAL_RTC_AlarmIRQHandler>
...
0800095c <SUBGHZ_Radio_IRQHandler>:
 ...
 8000960:	f027 fe25 	bl	80285ae <HAL_SUBGHZ_IRQHandler>
...
0800096c <TAMP_STAMP_LSECSS_SSRU_IRQHandler>:
 ...
 8000970:	f026 fb72 	bl	8027058 <HAL_RTCEx_SSRUIRQHandler>
...
0800098c <MX_USART2_UART_Init>:
 ...
 80009d4:	f01f fe32 	bl	802063c <Error_Handler>
 80009d8:	e7ed      	b.n	80009b6 <MX_USART2_UART_Init+0x2a>
 80009da:	f01f fe2f 	bl	802063c <Error_Handler>
 80009de:	e7ef      	b.n	80009c0 <MX_USART2_UART_Init+0x34>
 80009e0:	f01f fe2c 	bl	802063c <Error_Handler>
 80009e4:	e7f1      	b.n	80009ca <MX_USART2_UART_Init+0x3e>
 80009e6:	f01f fe29 	bl	802063c <Error_Handler>
...
08000a24 <HAL_UART_MspInit>:
 ...
 8000a56:	f024 fe6f 	bl	8025738 <HAL_RCCEx_PeriphCLKConfig>
 ...
 8000a9e:	f027 fe39 	bl	8028714 <HAL_GPIO_Init>
 8000aa2:	4622      	mov	r2, r4
 8000aa4:	4621      	mov	r1, r4
 8000aa6:	2025      	movs	r0, #37	; 0x25
 8000aa8:	f021 f996 	bl	8021dd8 <HAL_NVIC_SetPriority>
 8000aac:	2025      	movs	r0, #37	; 0x25
 8000aae:	f021 f9c5 	bl	8021e3c <HAL_NVIC_EnableIRQ>
 8000ab2:	e7c8      	b.n	8000a46 <HAL_UART_MspInit+0x22>
 8000ab4:	f01f fdc2 	bl	802063c <Error_Handler>
...
08000ac0 <HAL_UART_MspDeInit>:
 ...
 8000ade:	f027 fecb 	bl	8028878 <HAL_GPIO_DeInit>
 8000ae2:	2025      	movs	r0, #37	; 0x25
 8000ae4:	f021 f9b8 	bl	8021e58 <HAL_NVIC_DisableIRQ>
...
08000fa8 <fuota_FragDecoderRead>:
 ...
 8000fb8:	f01f f9f6 	bl	80203a8 <udrv_flash_read>
...
08000fc0 <fuota_FragDecoderWrite>:
 ...
 8000fd0:	f01f fa94 	bl	80204fc <udrv_flash_write>
...
08000fd8 <MlmeConfirm_fuota>:
 ...
 8000fde:	f022 ff33 	bl	8023e48 <UTIL_TIMER_IsRunning>
 ...
 8000ff8:	f022 ff96 	bl	8023f28 <UTIL_TIMER_Stop>
 8000ffc:	f644 6120 	movw	r1, #20000	; 0x4e20
 8001000:	4628      	mov	r0, r5
 8001002:	f023 f833 	bl	802406c <UTIL_TIMER_SetPeriod>
 8001006:	4628      	mov	r0, r5
 8001008:	f022 ffde 	bl	8023fc8 <UTIL_TIMER_Start>
...
08001040 <McpsIndication_fuota>:
 ...
 8001046:	f022 feff 	bl	8023e48 <UTIL_TIMER_IsRunning>
 ...
 8001066:	f022 ff5f 	bl	8023f28 <UTIL_TIMER_Stop>
 800106a:	f644 6120 	movw	r1, #20000	; 0x4e20
 800106e:	4628      	mov	r0, r5
 8001070:	f022 fffc 	bl	802406c <UTIL_TIMER_SetPeriod>
 8001074:	4628      	mov	r0, r5
 8001076:	f022 ffa7 	bl	8023fc8 <UTIL_TIMER_Start>
...
08001084 <bootloader_fuota_stack_init>:
 ...
 800108e:	f039 fa3d 	bl	803a50c <memcpy>
 ...
 80010a8:	0803b010 	.word	0x0803b010
...
080010b4 <fuota_LmHandlerPackageRegister>:
 ...
 8001110:	0801effd 	.word	0x0801effd
 8001114:	2000656c 	.word	0x2000656c
 8001118:	20006038 	.word	0x20006038

0800111c <fuota_LmHandlerRegister>:
 800111c:	b510      	push	{r4, lr}
 800111e:	f01e f987 	bl	801f430 <LmphClockSyncPackageFactory>
 8001122:	4604      	mov	r4, r0
 8001124:	2001      	movs	r0, #1
 8001126:	f01e f87d 	bl	801f224 <LmHandlerFuotaStackPackageRegister>
 800112a:	4621      	mov	r1, r4
 800112c:	2001      	movs	r0, #1
 800112e:	f7ff ffc1 	bl	80010b4 <fuota_LmHandlerPackageRegister>
 8001132:	f01e fc25 	bl	801f980 <LmhpRemoteMcastSetupPackageFactory>
 8001136:	4604      	mov	r4, r0
 8001138:	2002      	movs	r0, #2
 800113a:	f01e f873 	bl	801f224 <LmHandlerFuotaStackPackageRegister>
 800113e:	4621      	mov	r1, r4
 8001140:	2002      	movs	r0, #2
 8001142:	f7ff ffb7 	bl	80010b4 <fuota_LmHandlerPackageRegister>
 8001146:	f01e fe3f 	bl	801fdc8 <LmhpFragmentationPackageFactory>
 800114a:	4604      	mov	r4, r0
 800114c:	2003      	movs	r0, #3
 800114e:	f01e f869 	bl	801f224 <LmHandlerFuotaStackPackageRegister>
...
08001160 <bootloader_fuota_init>:
 ...
 8001166:	f02e fceb 	bl	802fb40 <LoRaMacUpdateCallbacks>
 800116a:	f01d fbec 	bl	801e946 <service_lora_fuota_get_band>
 800116e:	4c15      	ldr	r4, [pc, #84]	; (80011c4 <bootloader_fuota_init+0x64>)
 8001170:	7020      	strb	r0, [r4, #0]
 8001172:	f01f ff53 	bl	802101c <service_nvm_get_adr_from_nvm>
 8001176:	3800      	subs	r0, #0
 8001178:	bf18      	it	ne
 800117a:	2001      	movne	r0, #1
 800117c:	7060      	strb	r0, [r4, #1]
 800117e:	f01f ff17 	bl	8020fb0 <service_nvm_get_cfm_from_nvm>
 8001182:	70a0      	strb	r0, [r4, #2]
 8001184:	f01f ff6e 	bl	8021064 <service_nvm_get_dr_from_nvm>
 8001188:	70e0      	strb	r0, [r4, #3]
 800118a:	2501      	movs	r5, #1
 800118c:	7125      	strb	r5, [r4, #4]
 800118e:	f020 fa9d 	bl	80216cc <service_nvm_get_dcs_from_nvm>
...
080011d8 <fuota_init>:
 ...
 80011da:	f01c fe9e 	bl	801df1a <BoardInitMcu>
 80011de:	f01d fb89 	bl	801e8f4 <service_fuota_nvm_init>
 80011e2:	f01f fd8b 	bl	8020cfc <service_nvm_get_band_from_nvm>
 ...
 80011f8:	f01d fba5 	bl	801e946 <service_lora_fuota_get_band>
 ...
 8001202:	f02c fbd9 	bl	802d9b8 <LoRaMacInitialization>
 8001206:	bbb8      	cbnz	r0, 8001278 <fuota_init+0xa0>
 8001208:	f01d fb9d 	bl	801e946 <service_lora_fuota_get_band>
 800120c:	4c1f      	ldr	r4, [pc, #124]	; (800128c <fuota_init+0xb4>)
 800120e:	7020      	strb	r0, [r4, #0]
 8001210:	f01f ff04 	bl	802101c <service_nvm_get_adr_from_nvm>
 8001214:	3800      	subs	r0, #0
 8001216:	bf18      	it	ne
 8001218:	2001      	movne	r0, #1
 800121a:	7060      	strb	r0, [r4, #1]
 800121c:	f01f fec8 	bl	8020fb0 <service_nvm_get_cfm_from_nvm>
 8001220:	70a0      	strb	r0, [r4, #2]
 8001222:	f01f ff1f 	bl	8021064 <service_nvm_get_dr_from_nvm>
 8001226:	70e0      	strb	r0, [r4, #3]
 8001228:	2301      	movs	r3, #1
 800122a:	7123      	strb	r3, [r4, #4]
 800122c:	f020 fa4e 	bl	80216cc <service_nvm_get_dcs_from_nvm>
 ...
 8001244:	f01d fe8a 	bl	801ef5c <LmHandlerInit>
 8001248:	f7ff ff68 	bl	800111c <fuota_LmHandlerRegister>
 800124c:	f01d fb86 	bl	801e95c <service_fuota_lora_config>
 8001250:	f02c fd8e 	bl	802dd70 <LoRaMacStart>
 8001254:	2000      	movs	r0, #0
 8001256:	bd10      	pop	{r4, pc}
 8001258:	2001      	movs	r0, #1
 800125a:	f030 ff7f 	bl	803215c <RegionAS923SubBandSet>
 800125e:	e7c5      	b.n	80011ec <fuota_init+0x14>
 8001260:	2002      	movs	r0, #2
 8001262:	f030 ff7b 	bl	803215c <RegionAS923SubBandSet>
 8001266:	e7c3      	b.n	80011f0 <fuota_init+0x18>
 8001268:	2003      	movs	r0, #3
 800126a:	f030 ff77 	bl	803215c <RegionAS923SubBandSet>
 800126e:	e7c1      	b.n	80011f4 <fuota_init+0x1c>
 8001270:	2004      	movs	r0, #4
 8001272:	f030 ff73 	bl	803215c <RegionAS923SubBandSet>
...
0800129c <bootloader_fuota_start>:
 ...
 80012ce:	f020 fd83 	bl	8021dd8 <HAL_NVIC_SetPriority>
 80012d2:	200b      	movs	r0, #11
 80012d4:	f020 fdb2 	bl	8021e3c <HAL_NVIC_EnableIRQ>
 80012d8:	f022 fd86 	bl	8023de8 <UTIL_TIMER_Init>
 80012dc:	f7ff ff7c 	bl	80011d8 <fuota_init>
 80012e0:	f01d fb12 	bl	801e908 <service_lora_fuota_join>
 ...
 80012f4:	f022 fd88 	bl	8023e08 <UTIL_TIMER_Create>
 80012f8:	f644 6120 	movw	r1, #20000	; 0x4e20
 80012fc:	4620      	mov	r0, r4
 80012fe:	f022 feb5 	bl	802406c <UTIL_TIMER_SetPeriod>
 8001302:	4620      	mov	r0, r4
 8001304:	f022 fe60 	bl	8023fc8 <UTIL_TIMER_Start>
...
08001314 <OnClassChange>:
 ...
 8001352:	f01d fc03 	bl	801eb5c <LmHandlerSend>
...
08001394 <UplinkProcess>:
 ...
 8001398:	f01d fdea 	bl	801ef70 <LmHandlerIsBusy>
 ...
 80013c6:	f01e f837 	bl	801f438 <LmhpClockSyncAppTimeReq>
 80013ca:	e7ef      	b.n	80013ac <UplinkProcess+0x18>
 80013cc:	21ff      	movs	r1, #255	; 0xff
 80013ce:	2000      	movs	r0, #0
 80013d0:	f02a faf4 	bl	802b9bc <randr>
 ...
 80013ee:	f01d fbb5 	bl	801eb5c <LmHandlerSend>
...
08001420 <timer_callback>:
 ...
 8001422:	f02b fee1 	bl	802d1e8 <LoRaMacIsBusy>
 ...
 8001448:	f01d fa5e 	bl	801e908 <service_lora_fuota_join>
...
08001538 <HAL_UART_AbortReceive_IT>:
 ...
 800159c:	f02a f87e 	bl	802b69c <HAL_DMA_Abort_IT>
...
08001634 <HAL_UART_IRQHandler>:
 ...
 80017c6:	f029 ff69 	bl	802b69c <HAL_DMA_Abort_IT>
 ...
 800189a:	f029 fec9 	bl	802b630 <HAL_DMA_Abort>
...
08001e0c <UART_SetConfig>:
 ...
 8001f6a:	f023 fa8d 	bl	8025488 <HAL_RCC_GetPCLK1Freq>
 ...
 8001fb2:	f01b fc6d 	bl	801d890 <__aeabi_uldivmod>
 ...
 8001fc8:	f022 fe4e 	bl	8024c68 <HAL_RCC_GetSysClockFreq>
 ...
 8001fe8:	f023 fa4e 	bl	8025488 <HAL_RCC_GetPCLK1Freq>
 ...
 8002028:	f023 fa3e 	bl	80254a8 <HAL_RCC_GetPCLK2Freq>
 800202c:	e7de      	b.n	8001fec <UART_SetConfig+0x1e0>
 800202e:	f022 fe1b 	bl	8024c68 <HAL_RCC_GetSysClockFreq>
 ...
 8002038:	f023 fa26 	bl	8025488 <HAL_RCC_GetPCLK1Freq>
 ...
 800207c:	f023 fa14 	bl	80254a8 <HAL_RCC_GetPCLK2Freq>
 8002080:	e7dc      	b.n	800203c <UART_SetConfig+0x230>
 8002082:	f022 fdf1 	bl	8024c68 <HAL_RCC_GetSysClockFreq>
...
080021a2 <UART_WaitOnFlagUntilTimeout>:
 ...
 80021ce:	f022 fb1f 	bl	8024810 <HAL_GetTick>
...
0800227e <HAL_UART_Transmit>:
 ...
 80022b6:	f022 faab 	bl	8024810 <HAL_GetTick>
...
0800235c <HAL_UART_Receive>:
 ...
 8002398:	f022 fa3a 	bl	8024810 <HAL_GetTick>
...
08002488 <UART_CheckIdleState>:
 ...
 8002494:	f022 f9bc 	bl	8024810 <HAL_GetTick>
...
080027fc <Reset_Handler>:
 ...
 8002800:	f01d ff2e 	bl	8020660 <SystemInit>

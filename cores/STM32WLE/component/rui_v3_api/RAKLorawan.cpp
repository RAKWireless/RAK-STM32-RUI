...
bool RAKLorawan::registerPRecvCallback(service_lora_p2p_recv_cb_type callback) {
...
bool RAKLorawan::registerPSendCallback(service_lora_p2p_send_cb_type callback) {
...
bool RAKLorawan::registerPSendCADCallback(service_lora_p2p_send_CAD_cb_type callback) {
...
bool RAKLorawan::nwm::set(uint8_t value) {
    if ((SERVICE_LORA_WORK_MODE)value != service_lora_get_nwm()) {
        if (service_lora_set_nwm((SERVICE_LORA_WORK_MODE)value) == UDRV_RETURN_OK) {
            return true;
        } else {
            return false;
        }
...
//pfreq
uint32_t RAKLorawan::pfreq::get() {
    return service_lora_p2p_get_freq();
}

bool RAKLorawan::pfreq::set(uint32_t value) {
    if (SERVICE_LORAWAN == service_lora_get_nwm())
    {
        return false;
    }
...
//psf
uint8_t RAKLorawan::psf::get() {
    return service_lora_p2p_get_sf();
}

bool RAKLorawan::psf::set(uint8_t value) {
    if (SERVICE_LORAWAN == service_lora_get_nwm())
    {
        return false;
    }
...
//pbw
uint32_t RAKLorawan::pbw::get() {
    return service_lora_p2p_get_bandwidth();
}

bool RAKLorawan::pbw::set(uint32_t value) {
    if (SERVICE_LORAWAN == service_lora_get_nwm())
    {
        return false;
    }
...
//pcr
uint8_t RAKLorawan::pcr::get() {
    return service_lora_p2p_get_codingrate();
}

bool RAKLorawan::pcr::set(uint8_t value) {
    if (SERVICE_LORAWAN == service_lora_get_nwm())
    {
        return false;
    }
...
//ppl
uint16_t RAKLorawan::ppl::get() {
    return service_lora_p2p_get_preamlen();
}

bool RAKLorawan::ppl::set(uint16_t value) {
    if (SERVICE_LORAWAN == service_lora_get_nwm())
    {
        return false;
    }
...
//ptp
uint8_t RAKLorawan::ptp::get() {
    return service_lora_p2p_get_powerdbm();
}

//precv
bool RAKLorawan::precv(uint32_t timeout) {
    if (SERVICE_LORAWAN == service_lora_get_nwm())
    {
        return false;
    }
...
bool RAKLorawan::ptp::set(uint8_t value) {
    if (SERVICE_LORAWAN == service_lora_get_nwm())
    {
        return false;
    }
...
//psend
bool RAKLorawan::psend(uint8_t length, uint8_t *payload) {
    if (SERVICE_LORAWAN == service_lora_get_nwm())
    {
        return false;
    }
...
bool RAKLorawan::psend(uint8_t length, uint8_t *payload, bool cad_enable ) {
    if (SERVICE_LORAWAN == service_lora_get_nwm())
    {
        return false;
    }
...
//encry
bool RAKLorawan::encry::get() {
    return service_lora_p2p_get_crypto_enable();
}

bool RAKLorawan::encry::set(bool value) {
    if (SERVICE_LORAWAN == service_lora_get_nwm())
    {
        return false;
    }
...
//enckey
bool RAKLorawan::enckey::get(uint8_t *buff, uint32_t len) {
...
bool RAKLorawan::enckey::set(uint8_t *buff, uint32_t len) {
    if (SERVICE_LORAWAN == service_lora_get_nwm())
    {
        return false;
    }
...
//CRYPIV
bool RAKLorawan::enciv::get(uint8_t *buff, uint32_t len) {
...
bool RAKLorawan::enciv::set(uint8_t *buff, uint32_t len) {
    if (SERVICE_LORAWAN == service_lora_get_nwm())
    {
        return false;
    }
...
//pbr
uint32_t RAKLorawan::pbr::get() {
    return service_lora_p2p_get_bitrate();
}

bool RAKLorawan::pbr::set(uint32_t value) {
    if (SERVICE_LORAWAN == service_lora_get_nwm())
    {
        return false;
    }
...
//pfdev
uint32_t RAKLorawan::pfdev::get() {
    return service_lora_p2p_get_fdev();
}

bool RAKLorawan::pfdev::set(uint32_t value) {
    if (SERVICE_LORAWAN == service_lora_get_nwm())
    {
        return false;
    }

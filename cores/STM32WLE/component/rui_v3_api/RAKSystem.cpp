...
RAKSystem::firmwareVersion::firmwareVersion() {
  RAKSystem::firmwareVersion::ver = sw_version;
}

RAKSystem::cliVersion::cliVersion() {
  RAKSystem::cliVersion::ver = cli_version;
}
...
const String RAKSystem::firmwareVersion::get() {
    return RAKSystem::firmwareVersion::ver;
}

const String RAKSystem::cliVersion::get() {
    return RAKSystem::cliVersion::ver;
}
...
const String RAKSystem::modelId::get() {
    return RAKSystem::modelId::id;
}
